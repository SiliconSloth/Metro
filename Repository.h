...
public:
	...
	void create_commit(git_oid & id, std::string update_ref, const git_signature & author, const git_signature & committer, std::string message_encoding, std::string message, const git_tree & tree, std::vector<git_commit*> parents);
